...
def create_app():
    ...
    app.config['MAIL_USERNAME'] = 'your-email@example.com'  # Remplacez par votre adresse e-mail
    app.config['MAIL_PASSWORD'] = '***REMOVED-GMAIL-APP-PASSWORD***'  # Remplacez par votre mot de passe d'application
